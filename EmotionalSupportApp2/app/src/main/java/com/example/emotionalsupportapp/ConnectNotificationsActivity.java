...
public class ConnectNotificationsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_notifications);
        ...
        selectDateTurnOffNotifications.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(
                        ConnectNotificationsActivity.this,
    ...
    public void turnOffNotificationsForever(View view) {
        Toast.makeText(this, "You have selected turn off Connect notifications forever", Toast.LENGTH_SHORT).show();
    }
}
